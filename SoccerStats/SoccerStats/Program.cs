...
namespace SoccerStats
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                List<NewsResult> newsResults = GetNewsForPlayers(string.Format("{0} {1}", player.FirstName, player.LastName));
            ...
            SerializePlayersTopFile(topTenPlayers, fileName);
        ...
        public static void SerializePlayersTopFile(List<Player> players, string fileName)
        {
            var serializer = new JsonSerializer();
        ...
        public static List<NewsResult> GetNewsForPlayers(string playerName)
        {
            ...
            var webClient = new WebClient();
            webClient.Headers.Add("Ocp - Apim - Subscription - Key", "a550f88a3dec4f02ba28fb1782dcb0c0");
        ...
        public static SentimentResponse GetSentimentResponse(List<NewsResult> newsResults)
        {
            ...
            var webClient = new WebClient();
            webClient.Headers.Add("Ocp - Apim - Subscription - Key", "e79b74c258d84246b470fd719706560f");
            webClient.Headers.Add(HttpRequestHeader.Accept, "application/json");
            webClient.Headers.Add(HttpRequestHeader.ContentType, "application/json");
            string requestJson = JsonConvert.SerializeObject(sentimentRequest);
            byte[] requestBytes = Encoding.UTF8.GetBytes(requestJson);
            byte[] response = webClient.UploadData("https://westus.api.cognitive.microsoft.com/text/analytics/v2.1/sentiment", requestBytes);
